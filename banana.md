...
| 4 | **PLANILHA-DELIVERY** | 🧪 **só no teste** · **v17.71** · Excel ↓/↑ colunas Delivery | **NÃO** |
...
### 🧪 WIP — Planilha Excel Delivery / catálogo (`PLANILHA-DELIVERY` · **v17.71**)
...
| **Commit** | `2643889` · push `origin/teste` |
