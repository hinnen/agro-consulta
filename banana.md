...
### 📦 PACOTE PRONTO — Novo empréstimo no CP (`CP-NOVO-EMPRESTIMO` · **v17.92**)

| Item | Detalhe |
| ---- | ------- |
| **Status** | 🟡 **pronto para envio à produção** — `teste` · badge **v17.92** · **não** sobe loja sem frase + senha |
...
### ✅ CHECKLIST ÚNICO — pronto para envio (24/08 · teste **v17.92**)

| # | Pacote | Status | Migrate |
| - | ------ | ------ | ------- |
| 1 | **CP-NOVO-EMPRESTIMO** | 🟡 **pronto para envio à produção** · **v17.92** | **NÃO** |
...
> Loja hoje: ✅ **Live v17.84**. Tip `teste` **v17.92** = Novo empréstimo no CP (+ Outro + barras + via). Sem migrate. **Não** sobe sem frase + senha.
