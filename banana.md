...
- **PC app Chrome (`WA-PC-PWA` · 07/09):** a versão **web** (`/atendimento-whatsapp/`) instala como app (ícone «Zap PC») — botão **Instalar no PC** ou Chrome ⋮ → Instalar. Celular PWA continua separado.
