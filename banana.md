...
### 📦 PACOTE PRONTO — o que ainda falta subir · tip **v19.15** · 29/08/2026

| Item | Detalhe |
| ---- | ------- |
| **Tip** | `teste` **v19.15** · loja **v19.01** |
| **Prova** | PIN-OPERADOR-QUEM **50/50** · NFCE-DESC **56/56** · Repasse/cupom dinheiro |
| **Migrate** | não (neste lote) |
| **Status** | 🟡 **pronto para envio à produção** (aguarda frase + senha) |
| **Você** | Ctrl+F5 · PIN · Repasse · dinheiro+cupom · desconto+NFC-e |

### ✅ CHECKLIST ÚNICO — pronto para envio à produção (29/08c · tip **v19.15**)

| # | Pacote | O quê | Migrate | Status |
| - | ------ | ----- | ------- | ------ |
| 1 | `REPASSE-FORMULA-3VAL` | Planos+salário antes 50/50 · modal 3 valores · fix acum | não | 🟡 pronto envio |
| 2 | `PIN-OPERADOR-QUEM` | Exige PIN · sem Chrome · bug report · prova 50/50 | não | 🟡 pronto envio |
...
### ~~📦 PACOTE PRONTO — tips anteriores~~ · ver bloco tip **v19.15** acima
