...
- **Pedir loja (15/08):** overlay no wizard — Pedir/Recebidos/Enviados/Histórico · status sem mexer estoque · **Transferir** (botão rosa) move saldo · PIN da sessão · layout **só PC** (overlay **tela cheia**, **busca | pedido**, **tabela** Produto \| Centro \| Vila alinhada, nome **legível**) · saldo **Agro** (não wizard lite) · botão topbar rosa ao lado de Saldo Vila · WhatsApp fase 2 · migrate `estoque.0018`.
...
### WIP — Pedir loja tabela tela cheia (`PDV-PEDIR-LOJA-UX4`)

> **Status:** WIP no `teste` · **não** sobe loja sem frase+senha
> **Por quê:** v16.59 cortou nome (`m...`) e colunas continuaram tortas (`display:contents` no botão)
> **Feito:** overlay **100% da tela** · busca em **tabela** (padrão Uso loja) · nome inteiro
> **Você:** PDV local · **Ctrl+F5** · Pedir loja · busca milho
