...
**Versão app (`VERSION`):** **teste v5.37** · **produção LIVE v5.22** (`0a0fd52`)
...
| **Resumo** | **Zero fiado** — sem card, sem alerta vencido, sem total em aberto · **só aba Fiado** · top produtos grade — **v5.37** |
