...
**Versão app (VERSION):** **teste v11.53** · **loja v10.82** → pacote pronto **v10.85**
...
| **Agora** | Menu mais largo + prévia alinhada à direita |
| **Você** | Ctrl+F5 · conferir se cabe mais no menu sem scroll |
| **Status** | ⏳ validar layout tela |
