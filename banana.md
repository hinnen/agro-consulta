...
### ✅ CHECKLIST ÚNICO — pronto para envio (22/08b · teste **v17.76**)

| # | Pacote | Status | Migrate |
| - | ------ | ------ | ------- |
| 1 | **CATALOGO-SKIP-GERAL** | ✅ **pronto para envio** / teste **v17.76** | **NÃO** |

> Loja hoje: ✅ **Live v17.75** (PLANILHA-IMPORT-FACETA). Este lote **ainda não** foi à produção. Autorizar só com frase + senha **depois** de testar local (`/catalogo/` · Ctrl+F5).

### 📦 PACOTE PRONTO — Catálogo pula «Geral» (`CATALOGO-SKIP-GERAL` · **v17.76**)
...
| **Você** | **Ctrl+F5** `/catalogo/` · Cão → Adulto → Raças Médias e Grandes → **já os pesos** (sem «Geral») · Voltar volta à lista de Raças (não reabre Geral) · badge **17.76** |
