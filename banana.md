...
**Versão app (`VERSION`):** **teste v6.84** · **loja v6.77**

**WIP teste:** validar **v6.84** — fix entregas PDV vs fechar caixa (+ v6.81 caixa/FL-049/050)
...
| **Status** | **🧪 teste v6.83** — validar botão laranja + lista com caixa |
