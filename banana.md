...
### 📦 PACOTE PRONTO — Novo empréstimo no CP (`CP-NOVO-EMPRESTIMO` · **v17.91**)

| Item | Detalhe |
| ---- | ------- |
| **Status** | 🟡 **pronto para envio à produção** — `teste` · badge **v17.91** · **não** sobe loja sem frase + senha |
...
### ✅ CHECKLIST ÚNICO — pronto para envio (24/08 · teste **v17.91**)

| # | Pacote | Status | Migrate |
| - | ------ | ------ | ------- |
| 1 | **CP-NOVO-EMPRESTIMO** | 🟡 **pronto para envio à produção** · **v17.91** | **NÃO** |
...
> Loja hoje: ✅ **Live v17.84**. Tip `teste` **v17.91** = Novo empréstimo no CP (+ Outro + barras + via). Sem migrate. **Não** sobe sem frase + senha.
