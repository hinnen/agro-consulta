...
**Versão app (`VERSION`):** **teste v4.61** · **produção v4.49** (deploy merge **29/06**)
...
| **Versão** | **v4.61** — tela **Conferir entrega** revisão ERP (grade label/valor, total lateral, painel único) |
