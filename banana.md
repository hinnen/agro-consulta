...
### 📦 PREP — filtro loja DRE + BI (`DRE-LOJA-FILTRO` · **v15.55**)

> **Loja hoje:** ✅ **Live v15.54** · `producao` @ **4bf3410**  
> **⚠️** **NÃO** merge `teste`→`producao`. Este chat **não** autoriza loja. Lojas **abertas**.

| Item | Detalhe |
| ---- | ------- |
| **Status** | ✅ **PREP pronto** · aguarda pausa + frase + senha |
| **Branch** | `deploy/dre-loja-filtro-1008` @ **1f50976** · base loja **4bf3410** (v15.54) |
| **O quê** | DRE + BI: **Centro + Vila** (padrão) · Centro · Vila. Vendas/CMV = PDV. Despesas/emp. = empresa (Vila sem cadastro → Centro). |
| **Cirúrgico** | `views.py` só Números · BI **Números** sem mexer seletor PDV (`dash-agro-loja` + CSRF). PDV/caixa/wizard **0 diff**. |
| **Prova worktree** | check 0 · 50 unit · `verify_dre_loja_filtro_path.py` **VERIFY_OK** (80) |
| **Rollback** | `git push origin 4bf3410:producao` · tag depois do envio: `rollback/pre-dre-loja-filtro-v15.54` |
| **Migrate** | **NÃO** |
| **Fora** | PDV · caixa · wizard · Indicadores HTML |
| **Próximo chat** | Zap pausa · *«pode subir … produção»* + **99738595** · FF da branch → `producao` · Ctrl+F5 |

### ✅ CHECKLIST ÚNICO — PREP aguarda pausa+senha (10/08 · loja v15.54)
...
| 2 | **DRE-LOJA-FILTRO** | ✅ **PREP** / `deploy/dre-loja-filtro-1008` @ **1f50976** · aguarda pausa+senha | não |
