...
**Versão app (`VERSION`):** **teste v4.60** · **produção v4.49** (deploy merge **29/06**)
...
| **Versão** | **v4.60** — popups entrega **overlay fixo 16:9** (taxa, pagamento, troco); não cobre com zoom/rodapé |
