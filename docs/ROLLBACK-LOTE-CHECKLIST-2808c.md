# Rollback — lote checklist 2808c (loja alvo **v18.69**)
...
| **Branch backup (no deploy)** | `producao-backup-pre-v1869-lote-checklist-20260828` |
| **Branch PREP** | `deploy/prep-checklist-2808c` @ tip **v18.69** |
