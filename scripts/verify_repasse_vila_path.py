...
check("produtos/urls.py", "repasse_vila", "api/repasse-vila/confirmar/", "api/repasse-vila/acumulado/", "api/repasse-vila/acumulado/zerar/", "api/repasse-vila/reserva-log/")
check("produtos/models.py", "RepasseVilaCentroAgro", "RepasseVilaConfigAgro", "planos_desconto_centro", "RepasseVilaAcumuladoAjusteAgro", "RepasseVilaDeltaDiaAgro", "reserva_vila", "reserva_vila_desde", "RepasseVilaReservaLogAgro", "lucro_penultimo_dia")
