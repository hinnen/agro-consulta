...
check("produtos/repasse_vila_util.py", "ja_eletronico", "falta_dinheiro", "_ja_eletronico_vila", "validar_data_ref_repasse", "lucro_ficou_vila", "_receita_e_cmv_vila_periodo", "partir_despesas_centro_vila", "planos_desconto_centro")
check("produtos/views_repasse_vila.py", "repasse_vila_view", "api_repasse_vila_confirmar", "formas_pagamento", "validar_data_ref_repasse", "salvar_planos_desconto_centro")
check("produtos/urls.py", "repasse_vila", "api/repasse-vila/confirmar/")
check("produtos/models.py", "RepasseVilaCentroAgro", "RepasseVilaConfigAgro", "planos_desconto_centro")
check("produtos/migrations/0087_repasse_vila_centro.py", "RepasseVilaCentroAgro")
check("produtos/migrations/0091_repasse_planos_desconto_centro.py", "planos_desconto_centro")
check("produtos/templates/produtos/repasse_vila.html", "Transferir", "rv-data", "rv-day", "rv-lucro-ficou", "Enviado ao Centro", "Lucro ficou na Vila", "rv-btn-planos", "rv-planos-modal")
check("produtos/templates/produtos/partials/pdv/repasse_vila_overlay.html", "pdv-repasse-overlay", "pdv-rp-forma-grid", "pdv-rp-data", "pdv-rp-desp-hint")
check("produtos/static/produtos/js/pdv_repasse_vila.js", "api/repasse-vila/confirmar/", "forma_pagamento: formaPag", "data_ref: dataRef()", "despesas_centro_dia")
...
check("produtos/templates/produtos/includes/repasse_help_agents.html", "O que é este repasse", "hoje ou que passou", "Planos:")
