...
check("produtos/urls.py", "repasse_vila", "api/repasse-vila/confirmar/", "api/repasse-vila/acumulado/", "api/repasse-vila/acumulado/zerar/", "api/repasse-vila/reserva-log/", "api/repasse-vila/cofrinho/", "api/repasse-vila/cofrinho/separar/", "api/repasse-vila/cofrinho/movimento/", "api/repasse-vila/cofrinho/estornar/", "api/repasse-vila/envios/")
...
check("produtos/templates/produtos/partials/pdv/repasse_vila_overlay.html", "pdv-repasse-overlay", "pdv-rp-forma-grid", "pdv-rp-data", "pdv-rp-desp-hint", "pdv-rp-acum", "pdv-rp-acumulado", "pdv-rp-acum-modal", "pdv-rp-acum-zerar", "pdv-rp-reserva", "pdv-rp-cofre-aviso", "pdv-rp-hero-cofre", "pdv-rp-hero-cofre-ve", "pdv-rp-quem-modal", "pdv-rp-pin-modal", "pdv-rp-forma-modal", "Levar ao Centro", "A separar", "Levado ao Centro hoje", "pdv-rp-levado-hoje", "pdv-rp-totais-linha", "Cofrinho Salário funcionário", "Cofre Vila Elias", "rp-popup", "grid-template-columns", "pdv-rp-forcar-manual-modal", "PIN de novo", "pdv-rp-caixa-din", "Caixa Vila · dinheiro agora", "pdv-rp-hist-modal", "pdv-rp-hist-sal", "pdv-rp-hist-voltar")
...
check("produtos/templates/produtos/includes/repasse_help_agents.html", "O que é este repasse", "hoje ou que passou", "Planos:", "Ordem do lucro", "Acumulado", "abate sozinho", "Cofre Vila Elias", "Cofrinho Salário", "Saldo inicial")
...
check("scripts/verify_repasse_hist_overlay_path.py", "VERIFY_REPASSE_HIST_OVERLAY_PATH_OK", "openHistModal", "api/repasse-vila/envios/")
