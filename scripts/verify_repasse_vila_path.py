...
check("produtos/templates/produtos/repasse_vila.html", "Transferir", "rv-data", "rv-day", "rv-lucro-ficou", "Enviado ao Centro", "Lucro ficou na Vila", "rv-btn-planos", "rv-planos-modal", "rv-acum", "rv-btn-acum", "rv-acum-zerar", "acumulado já coberto por envio", "acumulado_bruto", "tot + acum", "rv-reserva", "rv-fold", "Dias 1 a 15", "Dias 16 a 31", "rv-log-lista", "penúltimo", "Ainda separar (acumulado)", "rv-cofre-saldo-inicial", "Saldo inicial", 'value="saldo_inicial"', "obrigacao_acumulada", "Não separar hoje soma amanhã")
check("produtos/templates/produtos/partials/pdv/repasse_vila_overlay.html", "pdv-repasse-overlay", "pdv-rp-forma-grid", "pdv-rp-data", "pdv-rp-desp-hint", "pdv-rp-acum", "pdv-rp-acumulado", "pdv-rp-acum-modal", "pdv-rp-acum-zerar", "pdv-rp-reserva", "pdv-rp-cofre-aviso", "NÃO levar", "pdv-rp-hero-cofre", "pdv-rp-quem-modal", "pdv-rp-pin-modal", "pdv-rp-forma-modal", "Levar ao Centro", "Cofrinho (ficar na Vila)", "rp-popup", "grid-template-columns")
...
check("produtos/templates/produtos/includes/repasse_help_agents.html", "O que é este repasse", "hoje ou que passou", "Planos:", "Acumulado", "abate sozinho", "Reserva diária do cofrinho", "Ainda separar (acumulado)", "Saldo inicial")
...
check("scripts/verify_repasse_pdv_overlay_path.py", "VERIFY_REPASSE_PDV_OVERLAY_OK", "focusSoon", "pdv-rp-quem-modal", "Levar ao Centro")
