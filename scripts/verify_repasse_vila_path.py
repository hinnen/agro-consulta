...
check("scripts/verify_repasse_pdv_overlay_path.py", "VERIFY_REPASSE_PDV_OVERLAY_OK", "focusSoon", "pdv-rp-quem-modal", "Levar ao Centro", "tryConfirmarFlow", "formaPag = 'Dinheiro'", "grid-template-columns", "pdv-rp-cofre-confirm-input-levar")
