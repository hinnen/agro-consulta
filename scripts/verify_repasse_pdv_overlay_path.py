...
check(HTML, "pdv-rp-cofre-confirm-modal", "pdv-rp-cofre-confirm-input-sal", "pdv-rp-cofre-confirm-input-ve", "pdv-rp-cofre-confirm-input-levar", "pdv-rp-cofre-confirm-ok", "rp-cofre-confirm-panel")
check(HTML, "edite os 3 valores", "80vw", "80dvh")
...
check(JS, "openCofreConfirmModal", "closeCofreConfirmModal", "enviarConfirmacao", "notifyParentFecharAtualizar", "valor_cofre_salario", "parseMoneyInput")
