...
check(HTML, "Confirma a transferência", "80vw", "80dvh")
...
check(JS, "openCofreConfirmModal", "closeCofreConfirmModal", "enviarConfirmacao", "notifyParentFecharAtualizar", "valor_cofre_salario", "parseMoneyInput", "inputCofreSal", "pdv-rp-input-cofre-sal", "Preencha os 3 valores")
