...
check(JS, "openCofreConfirmModal", "closeCofreConfirmModal", "enviarConfirmacao", "notifyParentFecharAtualizar", "valor_cofre_salario", "parseMoneyInput", "inputCofreSal", "pdv-rp-input-cofre-sal", "pode ser 0,00", "zeroSeVazio", "cofreCheckPassosAtivos", "openCofreCheckSequence", "advanceCofreCheck", "COFRE_CHECK_PASSOS", "pointerEvents", "forcar_manual_zerado = true")
