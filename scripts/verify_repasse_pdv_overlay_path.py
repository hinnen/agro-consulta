...
check(HTML, "pdv-rp-cofre-confirm-modal", "pdv-rp-cofre-confirm-valor", "pdv-rp-cofre-confirm-ok", "rp-cofre-confirm-panel")
check(HTML, "NÃO coloque esse valor no envelope", "Confirmar repasse", "80vw", "80dvh")
...
check(JS, "openCofreConfirmModal", "closeCofreConfirmModal", "enviarConfirmacao", "notifyParentFecharAtualizar")
