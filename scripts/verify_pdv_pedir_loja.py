...
def main() -> int:
    ...
    check("overlay_pc_largo", "96rem" in html)
    check("overlay_altura_unica", "height: 100%" in html and "h-[min(92dvh" not in html)
    check("overlay_grid_pc", "pl-pedir-grid" in html and "pl-col--pedido" in html)
    check("overlay_hits_colunas", "pl-hits-head" in html and "6.25rem 6.25rem" in html)
    check("overlay_nome_uma_linha", "text-overflow: ellipsis" in html)
