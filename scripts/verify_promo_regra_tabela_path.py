"""
PROMO-REGRA-TABELA-SAVE ÔÇö path promo ├ù tabela % (save, load, PDV util).
...
def main() -> int:
    ...
    check("state.regra_vs_tabela" in script, "hydrateForm l├¬ regra_vs_tabela")
    ...
    check(regra_promo_vs_tabela(9, 10, "promo") == 9, "regra promo ÔåÆ 9")
    check(regra_promo_vs_tabela(9, 10, "tabela") == 10, "regra tabela ÔåÆ 10")
    check(regra_promo_vs_tabela(9, 10, "maior") == 10, "regra maior ÔåÆ 10")
